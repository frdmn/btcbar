//
//  PoloniexXLMFetcher.m
//  btcbar
//

#import "PoloniexXLMFetcher.h"

@implementation PoloniexXLMFetcher
...
- (id)init
{
    ...
    {
        // Menu Item Name
        self.ticker_menu = @"Lumens/USD (Poloniex)";
...
- (void)requestUpdate
{
    ...
    [request addValue:@"btcbar/2.0 (PoloniexXLMFetcher)" forHTTPHeaderField:@"User-Agent"];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    ...
    {
        // Get API status
        NSString *resultsStatus = [results valueForKeyPath:@"USDT_STR.last"];
